...
const Terms = () => {
  return (
    <Container>
      ...
      <div>GoPlan is located at:</div>
      <address>NY , United States</address>
      <div>
        Contact:{' '}
        <a
          href="mailto:goplanapp@gmail.com"
          title="send an email to goplanapp@gmail.com"
        >
          goplanapp@gmail.com
        </a>
      </div>
      <Copy>
        ...
        conditions in full. Do not continue to use GoPlan&#39;s website if you
      ...
      <Copy>
        ...
        accordance with and subject to, prevailing law of United States. Any use
      ...
      <Title>Cookies</Title>
      <Copy>
        We employ the use of cookies. By using GoPlan&#39;s website you consent
        to the use of cookies in accordance with GoPlan&#39;s privacy policy.
      </Copy>
      <Copy>
      ...
      <Title>License</Title>
      <Copy>
        Unless otherwise stated, GoPlan and/or it&#39;s licensors own the
        intellectual property rights for all material on GoPlan. All
        intellectual property rights are reserved. You may view and/or print
        pages from https://goplantravelling.com for your own personal use
        subject to restrictions set in these terms and conditions.
      </Copy>
      <Copy>You must not:</Copy>
      <ol>
        <li>Republish material from https://goplantravelling.com</li>
        <li>
          Sell, rent or sub-license material from https://goplantravelling.com
        </li>
        <li>
          Reproduce, duplicate or copy material from
          https://goplantravelling.com
        </li>
      </ol>
      <Copy>
        Redistribute content from GoPlan (unless content is specifically made
        for redistribution).
      </Copy>
      ...
      <ol>
        ...
        <li>
          ...
          and exchange opinions, information, material and data
          (&#39;Comments&#39;) in areas of the website. GoPlan does not screen,
          edit, publish or review Comments prior to their appearance on the
          website and Comments do not reflect the views or opinions ofGoPlan,
          ...
          applicable laws GoPlanshall not be responsible or liable for the
        ...
        <li>
          GoPlanreserves the right to monitor all Comments and to remove any
        ...
        <li>
          You hereby grant to <strong>GoPlan</strong> a non-exclusive
      ...
      <Copy>
        ...
        GoPlan; and (d) where the link is in the context of general resource
      ...
      <Copy>
        No use of GoPlan&#39;s logo or other artwork will be allowed for linking
      ...
      <Title></Title>
      <Copy></Copy>
      <Title>Credit & Contact Information</Title>
      <Copy>
